...
var settings;
var armizareGame = Game.get( 'armizare' );
if( armizareGame != null ) {
	settings = armizareGame.masterSettings;
} else {
...
useLibrary( 'project:armizare/resources/namedobj.js' );
...
var projBase = 'project:armizare/resources/text/';
